...
use bash::features::{
    ...
    host_power as bash_host_power, infrastructure as bash_infrastructure,
    invocation as bash_invocation, kubernetes as bash_kubernetes,
    local_utilities as bash_local_utilities, logical_storage as bash_logical_storage,
    lookup as bash_lookup, model as bash_model, network as bash_network, project as bash_project,
    registry as bash_registry, remote_source_control as bash_remote_source_control,
    rsync_options as bash_rsync_options, self_protection as bash_self_protection,
    semantics as bash_semantics, socat as bash_socat,

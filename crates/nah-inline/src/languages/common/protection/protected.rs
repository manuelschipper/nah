...
use crate::syntax::{StaticCallArgument, static_call_arguments};
use crate::{EnvironmentValue, normalized_program};

use super::support::{
    EnvironmentVariables, environment_operation, protected_path, protected_path_ancestor,
    runtime_launch_bypass, runtime_launch_program, runtime_name,
};

pub(super) fn python_mutates_protected_ancestor(
    outside: &str,
    strings: &[String],
...
pub(super) fn protected_namespace_ancestor_target(
    outside: &str,
    strings: &[String],
    home: &str,
    critical_paths: &[AbsolutePath],

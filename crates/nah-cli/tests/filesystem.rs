...
fn catastrophic_filesystem_guards_block_visible_bash_effects_end_to_end() {
    ...
    let mut cases: Vec<(String, &str)> = vec![
        ("rm -rf /".to_owned(), "fs-root"),
        ("rm -rf /bin".to_owned(), "fs-root"),
        ("rm -rf /usr/bin".to_owned(), "fs-root"),
        ("rm -rf /usr/sbin".to_owned(), "fs-root"),
        ("rm -rf /tmp".to_owned(), "fs-root"),
        ("rm -rf /dev".to_owned(), "fs-root"),
        ("> /proc/sysrq-trigger".to_owned(), "fs-raw-device"),
        ("rm -rf /proc".to_owned(), "fs-root"),
        ("rm -rf /sys".to_owned(), "fs-root"),
        ("rm -rf /run".to_owned(), "fs-root"),
        ("rm -rf /private/tmp".to_owned(), "fs-root"),
        ...
        ("bash -c 'rm -rf /'".to_owned(), "fs-root"),
        ("bash <<< 'rm -rf /'".to_owned(), "fs-root"),
        ("f(){ rm -rf /; }; f".to_owned(), "fs-root"),
        ("coproc rm -rf /".to_owned(), "fs-root"),
        ("command -- rm -rf /".to_owned(), "fs-root"),
        ("env SAFE=1 rm -rf /".to_owned(), "fs-root"),
        ("env -u SAFE rm -rf /".to_owned(), "fs-root"),
        ("sudo -u root rm -rf /".to_owned(), "fs-root"),
        ("sudo -nE SAFE=1 /bin/rm -rf /".to_owned(), "fs-root"),
        ("/usr/bin/sudo -- /bin/rm -rf /".to_owned(), "fs-root"),
        ("rm -rf /{etc,usr}".to_owned(), "fs-root"),
        ...
        ("chown -h -R --reference=/tmp/ref /".to_owned(), "fs-root"),
        ("chmod -R --reference --help /".to_owned(), "fs-root"),
        ("busybox rm -rf /".to_owned(), "fs-root"),
        ("find / -delete".to_owned(), "fs-root"),
        ("find / -name --help -delete".to_owned(), "fs-root"),
        ("find / -exec echo --help ';' -delete".to_owned(), "fs-root"),
        ("find / -exec rm -rf '{}' +".to_owned(), "fs-root"),
        ("find / -exec chmod -R 000 '{}' +".to_owned(), "fs-root"),
        ("find / -exec chmod 000 '{}' +".to_owned(), "fs-root"),
        ("find / -exec chown root '{}' +".to_owned(), "fs-root"),
        ("find / -exec chgrp root '{}' +".to_owned(), "fs-root"),
        ("find / -exec setfacl -b '{}' +".to_owned(), "fs-root"),
        ("find ~ -exec chmod 000 '{}' +".to_owned(), "fs-home"),
        ("rsync --delete source/ /".to_owned(), "fs-root"),
        (
    ...
    if cfg!(target_os = "linux") {
        cases.extend([
            ("/bin/chmod --rec 000 /".to_owned(), "fs-root"),
            ("command /usr/bin/chmod --rec 000 /".to_owned(), "fs-root"),
            ("env /usr/bin/chown --rec root /".to_owned(), "fs-root"),
            ("busybox chmod --rec 000 /".to_owned(), "fs-root"),
            ("cd / && chmod --rec 000 \"$PWD\"".to_owned(), "fs-root"),
        ]);
    }

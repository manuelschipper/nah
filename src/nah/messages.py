...
_ACTION_MESSAGES = {
    ...
    taxonomy.SERVICE_INSPECT: "this inspects local service state",
    taxonomy.SERVICE_READ: "this reads remote service or API state",
    ...
    taxonomy.ENV_READ: "this exposes environment or secret-bearing state",
